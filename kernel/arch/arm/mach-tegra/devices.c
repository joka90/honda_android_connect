...
static struct resource tegra_disp1_hdmi_resources[] = {
	{
		.name	= "irq",
		.start	= INT_DISPLAY_GENERAL,
		.end	= INT_DISPLAY_GENERAL,
...
struct nvhost_device tegra_disp1_hdmi_device = {
	.name		= "tegradc",
	.id		= 0,
	.resource	= tegra_disp1_hdmi_resources,
	.num_resources	= ARRAY_SIZE(tegra_disp1_hdmi_resources),
};
