...
#define ADA_LOG_ST_ERR(...)
#define ADA_LOG_ST_WARNING(...)
#define ADA_LOG_ST_TRACE(...)
#define ADA_LOG_ST_NOTICE(...)
#define ADA_LOG_ST_INFO(...)
#define ADA_LOG_ST_DEBUG(...)
