...
/* ADD start FUJITSU TEN :2013-02-18 LSM */
#ifndef CONFIG_SECURITY_FJSEC
static int cap_kernel_load_module(char *name, void __user *umod, unsigned long len)
{
	return 0;
}
#endif /* CONFIG_SECURITY_FJSEC */
...
//	set_to_cap_if_null(ops, ptrace_request_check);
...
//	set_to_cap_if_null(ops, kernel_load_module);
