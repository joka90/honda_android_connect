...
snd_pcm_sframes_t snd_pcm_bytes_to_frames(snd_pcm_t *pcm, ssize_t bytes)
{
	...
	if (CHECK_SANITY(! pcm->setup)) {
		SNDMSG("PCM not set up");
/* FUJITSU TEN:2013-10-17 AUDIO modify start */
		return -EBADF;
/* FUJITSU TEN:2013-10-17 AUDIO modify end */
	}
/* FUJITSU TEN:2013-10-17 AUDIO add start */
	if (0 == pcm->frame_bits) {
		SNDMSG("PCM 0 frame_bits");
		return -EBADF;
	}
/* FUJITSU TEN:2013-10-17 AUDIO add end */
