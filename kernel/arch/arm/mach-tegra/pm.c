...
/* definition for the tristate setting */
...
/* FUJITSU TEN:2012-11-07 Suspend Resume start */
#ifdef CONFIG_ADA_BUDET_DETECT
static enum tegra_suspend_mode current_suspend_mode = TEGRA_SUSPEND_LP0;
#else
...
/* FUJITSU TEN:2013-04-25 Move to previce of enable DPD-SAMPLE. start */
///* FUJITSU TEN:2012-11-07 Suspend Resume start */
//#ifdef CONFIG_ADA_BUDET_DETECT
...
//#endif /* CONFIG_ADA_BUDET_DETECT */
///* FUJITSU TEN:2012-11-07 Suspend Resume end */
/* FUJITSU TEN:2013-04-25 Move to previce of enable DPD-SAMPLE. end */
...
#endif
		if (pdata && pdata->early_emc_restore)
			tegra_lp0_suspend_emc();
...
/* FUJITSU TEN:2012-11-07 Suspend Resume start */
#ifdef CONFIG_ADA_BUDET_DETECT
    /* based on Design_document_PlanG_0829_FTEN.docx(P22), */
    /* set late device tristate in LP0. */
    if (current_suspend_mode == TEGRA_SUSPEND_LP0) {
        pm_set_late_tristate_pin(TEGRA_TRI_TRISTATE);
    }
#endif /* CONFIG_ADA_BUDET_DETECT */
/* FUJITSU TEN:2012-11-07 Suspend Resume end */
