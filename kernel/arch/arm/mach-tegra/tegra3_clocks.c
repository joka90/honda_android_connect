...
static int tegra3_cpu_clk_set_rate(struct clk *c, unsigned long rate)
{
	...
	if (c->dvfs) {
		if (!c->dvfs->dvfs_rail)
			return -ENOSYS;
		else if ((!c->dvfs->dvfs_rail->disabled) && (!c->dvfs->dvfs_rail->reg) &&
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("sata_oob",	"tegra_sata_oob",	NULL,	123,	0x420,	272000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("sata",	"tegra_sata",		NULL,	124,	0x424,	272000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	...
	PERIPH_CLK("se",	"tegra-se",		NULL,	127,	0x42c,	625000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | DIV_U71_INT),
#ifdef CONFIG_TEGRA_PCI
	PERIPH_CLK("mselect",	"mselect",		NULL,	99,	0x3b4,	204000000, mux_pllp_clkm,		MUX | DIV_U71),
#else
	PERIPH_CLK("mselect",	"mselect",		NULL,	99,	0x3b4,	102000000, mux_pllp_clkm,		MUX | DIV_U71),
#endif
