...
void RenderBlock::computePreferredLogicalWidths()
{
    ...
    /* FUJITSU TEN:2013-04-18 Generic(4E) chg start */
    /* FUJITSU:2012-05-21 DEL-S */
    //if (!isTableCell() && style()->logicalWidth().isFixed() && style()->logicalWidth().value() > 0)
    /* FUJITSU:2012-05-21 DEL-E */
    /* FUJITSU:2012-05-21 ADD-S */
    if (!isTableCell() && style()->logicalWidth().isFixed() && style()->logicalWidth().value() > 0
            && style()->marqueeBehavior() != MALTERNATE)
    /* FUJITSU:2012-05-21 ADD-E */
    /* FUJITSU TEN:2013-04-18 Generic(4E) chg end */
