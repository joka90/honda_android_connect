...
static struct gpio p852_sku23_gpios[] = {
	...
	{TEGRA_GPIO_PA0, GPIOF_OUT_INIT_HIGH, "usbpwr2_ena"},
	...
	{TEGRA_GPIO_PV3, GPIOF_OUT_INIT_LOW, "v3"},
	...
	{TEGRA_GPIO_PK2, GPIOF_IN, "usb1_ovrc"},
	{TEGRA_GPIO_PT6, GPIOF_IN, "usb2_ovrc"},
	{TEGRA_GPIO_PD2, GPIOF_IN, "usb3_ovrc"},
};
...
static struct gpio p852_sku23_c01_gpios[] = {
	{TEGRA_GPIO_PW1, GPIOF_OUT_INIT_HIGH, "usbpwr0_ena"},
	{TEGRA_GPIO_PB2, GPIOF_OUT_INIT_HIGH, "usbpwr1_ena"},
	{TEGRA_GPIO_PA0, GPIOF_OUT_INIT_HIGH, "usbpwr2_ena"},
	...
	{TEGRA_GPIO_PD5, GPIOF_IN, "d5"},
	{TEGRA_GPIO_PBB1, GPIOF_OUT_INIT_LOW, "bb1"},
	{TEGRA_GPIO_PR0, GPIOF_OUT_INIT_LOW, "therm_shutdown"},
	{TEGRA_GPIO_PD4, GPIOF_IN, "therm_alert"},
	{TEGRA_GPIO_PK2, GPIOF_IN, "usb1_ovrc"},
	{TEGRA_GPIO_PT6, GPIOF_IN, "usb2_ovrc"},
	{TEGRA_GPIO_PD2, GPIOF_IN, "usb3_ovrc"},
	{TEGRA_GPIO_PN7, GPIOF_IN, "timepulse_gps"},
};

static struct gpio p852_sku24_c01_gpios[] = {
	{TEGRA_GPIO_PW1, GPIOF_OUT_INIT_HIGH, "usbpwr0_ena"},
	{TEGRA_GPIO_PA0, GPIOF_OUT_INIT_HIGH, "usbpwr2_ena"},
	{TEGRA_GPIO_PV0, GPIOF_IN, "v0"},
	{TEGRA_GPIO_PV1, GPIOF_IN, "v1"},
...
static struct gpio p852_sku25_c01_gpios[] = {
	{TEGRA_GPIO_PW1, GPIOF_OUT_INIT_HIGH, "usbpwr0_ena"},
	{TEGRA_GPIO_PB2, GPIOF_OUT_INIT_HIGH, "usbpwr1_ena"},
	{TEGRA_GPIO_PA0, GPIOF_OUT_INIT_HIGH, "usbpwr2_ena"},
	{TEGRA_GPIO_PV0, GPIOF_IN, "v0"},
...
static struct gpio p852_sku5_b00_gpios[] = {
	{TEGRA_GPIO_PW1, GPIOF_OUT_INIT_HIGH, "usbpwr0_ena" },
	{TEGRA_GPIO_PB2, GPIOF_OUT_INIT_HIGH, "usbpwr1_ena" },
	{TEGRA_GPIO_PA0, GPIOF_OUT_INIT_HIGH, "usbpwr2_ena" },
	{TEGRA_GPIO_PV2, GPIOF_OUT_INIT_HIGH, "v2" },
...
static struct gpio p852_sku5_c01_gpios[] = {
	{TEGRA_GPIO_PW1, GPIOF_OUT_INIT_HIGH, "usbpwr0_ena" },
	{TEGRA_GPIO_PA0, GPIOF_OUT_INIT_HIGH, "usbpwr2_ena" },
	{TEGRA_GPIO_PV0, GPIOF_IN, "v0"},
	{TEGRA_GPIO_PV1, GPIOF_IN, "v1"},
...
void __init p852_gpio_init(void)
{
	...
	case P852_SKU23_C01:
		{
			gpios_info = p852_sku23_c01_gpios;
			pin_count = ARRAY_SIZE(p852_sku23_c01_gpios);
		}
		break;
	case P852_SKU24_C01:
		{
			gpios_info = p852_sku24_c01_gpios;
			pin_count = ARRAY_SIZE(p852_sku24_c01_gpios);
		}
		break;
	case P852_SKU25_C01:
		{
			gpios_info = p852_sku25_c01_gpios;
			pin_count = ARRAY_SIZE(p852_sku25_c01_gpios);
		}
		break;
	case P852_SKU5_B00:
		{
			gpios_info = p852_sku5_b00_gpios;
			pin_count = ARRAY_SIZE(p852_sku5_b00_gpios);
		}
	case P852_SKU5_C01:
		{
			gpios_info = p852_sku5_c01_gpios;
			pin_count = ARRAY_SIZE(p852_sku5_c01_gpios);
		}
		break;
	case P852_SKU8_B00:
	case P852_SKU8_C01:
