...
#define ISR_LL_DONE				REG_BIT(3)
#define ISR_LL_ERR				REG_BIT(2)
...
/* register enable bits command queue packet */
//#define CQ_CONFIG_EN			REG_BIT(0)
//#define CQ_DMA_CFG_A_EN		REG_BIT(1)
//#define CQ_DMA_CFG_B_EN		REG_BIT(2)
#define CQ_DATA_BLOCK_PTR_EN		REG_BIT(3)
//#define CQ_TAG_PTR_EN			REG_BIT(4)
//#define CQ_ECC_PTR_EN			REG_BIT(5)
#define CQ_DMA_MST_CTRL_EN		REG_BIT(6)
#define CQ_ADDR_REG1_EN			REG_BIT(7)
#define CQ_ADDR_REG2_EN			REG_BIT(8)
#define CQ_CMD_REG1_EN			REG_BIT(9)
#define CQ_CMD_REG2_EN			REG_BIT(10)
//#define CQ_HWSTATUS_CMD_EN		REG_BIT(11)
//#define CQ_HWSTATUS_MASK_EN		REG_BIT(12)
#define CQ_COMMAND_EN			REG_BIT(13)
#define CQ_COMMAND_PACKETID(val) 	REG_FIELD((val), 24, 8)

enum {
/* packet data offsets in a command queue packet */
// CQ_CONFIG_REG,
// CQ_DMA_CFG_A_REG,
// CQ_DMA_CFG_B_REG,
CQ_DATA_BLOCK_PTR_REG,
// CQ_TAG_PTR_REG,
// CQ_ECC_PTR_REG,
CQ_DMA_MST_CTRL_REG,
CQ_ADDR_REG1_REG,
...
CQ_CMD_REG2_REG,
//CQ_HWSTATUS_CMD_REG,
//CQ_HWSTATUS_MASK_REG,
CQ_COMMAND_REG,
CQ_MAX_REG,
};
#define LL_CONFIG_START			REG_BIT(31)
#define LL_CONFIG_WORD_CNT_EN		REG_BIT(19)
#define LL_CONFIG_BURST_WORD(val) 	REG_FIELD((val), 16, 3)
#define LL_CONFIG_LENGTH(val) 		REG_FIELD((val), 0, 11)
