...
static int tegra_wake_event_irq_t3[] = {
	...
	/* FUJITSU TEN:2013-07-11 Disable TEGRA_GPIO_PW2 Wake Start */
	// TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PW2),	/* wake12 */
	-EINVAL,	/* wake12 */
	/* FUJITSU TEN:2013-07-11 Disable TEGRA_GPIO_PW2 Wake End */
	TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PY6),	/* wake13 */
	TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PDD3),	/* wake14 */
	TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PJ2),	/* wake15 */
	INT_RTC,				/* wake16 */
	INT_KBC,				/* wake17 */
	/* FUJITSU TEN:2013-07-11 Disable PMU Wake Start */
	// INT_EXTERNAL_PMU,			/* wake18 */
	-EINVAL,							/* wake18 */
	/* FUJITSU TEN:2013-07-11 Disable PMU Wake end */
	...
	/* FUJITSU TEN:2013-07-04 Disable USB Wake Start */
	...
	/* FUJITSU TEN:2013-07-04 Disable USB Wake End */
};
