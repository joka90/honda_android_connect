...
/* FUJITSU TEN:2013-03-07 Generic(3B) add start */
  _dbus_connection_ref_unlocked (connection);
/* FUJITSU TEN:2013-03-07 Generic(3B) add end */
...
/* FUJITSU TEN:2013-03-07 Generic(3B) chg start */
#if 0
      if (pending)
        dbus_pending_call_unref (pending);
#else
      _dbus_warn("call dbus_connection_unref()");
#endif
/* FUJITSU TEN:2013-03-07 Generic(3B) chg end */
