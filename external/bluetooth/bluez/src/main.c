...
/* Source file ID */
#define BLUEZ_SRC_ID BLUEZ_SRC_ID_SRC_MAIN_C
...
static void init_defaults(void)
{
	...
	main_opts.name	= g_strdup("Honda HFT");
...
int main(int argc, char *argv[])
{
	...
	BLUEZ_DEBUG_WARN("[MAIN] setOomAdjSystem Start.");
	EVENT_DRC_BLUEZ_INIT(FORMAT_ID_BT_INIT, INIT_BLUEZ);
	if(OOM_OK != setOomAdjSystem()){
		BLUEZ_DEBUG_ERROR("[Bluez - MAIN] setOomAdjSystem() Fail.");
		ERR_DRC_BLUEZ(ERROR_BLUEZ_SET_OOM, 0, 0);
	}
