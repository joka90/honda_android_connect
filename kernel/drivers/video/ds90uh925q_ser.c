...
static int __init ds90uh925q_init(void)
{
	return i2c_add_driver(&ds90uh925q_driver);
}
module_init(ds90uh925q_init);

static void __exit ds90uh925q_exit(void)
{
	i2c_del_driver(&ds90uh925q_driver);
}
module_exit(ds90uh925q_exit);
