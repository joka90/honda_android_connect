...
/* 2013-03-04 Fujitsu ten: disable vdd supply */
/*
 ...
 */
/* 2013-05-23 Fujitsu ten: disable vdd supply */
/* 2013-05-27 Fujitsu ten: Sus-Rej start */
#if 0
	REGULATOR_SUPPLY("avdd_usb_pll", NULL),
	/* NOTE: avdd_usb : SYS3.3V_LATE(from BU3.3V) */
	REGULATOR_SUPPLY("avdd_usb", "tegra-ehci.0"),
	REGULATOR_SUPPLY("avdd_usb", "tegra-ehci.1"),
	REGULATOR_SUPPLY("avdd_usb", "tegra-ehci.2"),
	REGULATOR_SUPPLY("avdd_usb", "tegra-udc.0"),
#endif
/* 2013-05-27 Fujitsu ten: Sus-Rej end */
/* 2013-05-23 Fujitsu ten: disable vdd supply */
/*
...
/* p1852 setting */
/* VDD1: NOT USED -> 1.2v(use EN1) */
TPS_PDATA_INIT(vdd1, 0,	1200,  1200, 0 , 0, EXT_CTRL_EN1 /* EXT_CTRL_SLEEP_OFF */, 0);
/* VDD2: DDR3(VDDIO_DDR) , 1.5V, SLEEP=ON */
TPS_PDATA_INIT(vdd2, 0, 1500, 1500, 0, 0, 0, 0);
/* VIO: Tegra VIO(VDDIO_SYS), 1.8V, SLEEP=ON */
TPS_PDATA_INIT(vio,  0, 1800, 1800, 0, 0, 0, 0);

/* EXTCTRL: Tegra CORE(VDD_CORE), 1.25V, SLEEP=OFF */
TPS_PDATA_INIT(vddctrl, 0, 1250,  1250, 0, 0, EXT_CTRL_SLEEP_OFF, 0);

/* LDO1: Unused */
TPS_PDATA_INIT(ldo1, 0, 1000, 3300, 0, 0, EXT_CTRL_SLEEP_OFF, 0);
/* LDO2: Tegra PLL, 1.2V, SLEEP=OFF */
TPS_PDATA_INIT(ldo2, 0, 1200, 1200, 0, 0, EXT_CTRL_SLEEP_OFF, 0);

/* LDO3: Unused -> 2.5v(use EN2) */
TPS_PDATA_INIT(ldo3, 0, 2500, 2500, 0, 0 , EXT_CTRL_EN2  /* EXT_CTRL_SLEEP_OFF */, 0);
/* LDO4: Tegra RTC 1.25V -> HDMI 1.2V , SLEEP=ON */
TPS_PDATA_INIT(ldo4, 0, 1200, 1200, 0, 0 , 0, 0);
/* LDO5: VDD_DDR_HS, 1.0, SLEEP=OFF */
TPS_PDATA_INIT(ldo5, 0, 1000, 1000, 0, 0, EXT_CTRL_SLEEP_OFF, 0);

/* LDO6: OSC/USB_PLL, 1.8V, SLEEP=OFF */
TPS_PDATA_INIT(ldo6, 0, 1800, 1800, 0, 0, EXT_CTRL_SLEEP_OFF, 0);
/* LDO7: VDD_DDR_RX, 2.8V , SLEEP=OFF */
TPS_PDATA_INIT(ldo7, 0, 2800, 2800, 0, 0, EXT_CTRL_SLEEP_OFF, 0);
/* LDO8: Unused -> 3.3v(use EN2) */
TPS_PDATA_INIT(ldo8, 0, 3300, 3300, 0, 0, EXT_CTRL_EN2 /* EXT_CTRL_SLEEP_OFF */ , 0);
...
*/
/* p1852 setting */
/* No need for GPIO setting(automatically disabled by PMU) */
};
...
static struct tps6591x_platform_data tps_platform = {
	...
	.use_power_off	= true,
	/* FUJITSU TEN:2013-03-07 disable sleep bit control start */
	//.dev_slp_delayed = true,
	/* FUJITSU TEN:2013-03-07 disable sleep bit control end */
};

static struct i2c_board_info __initdata e1853_regulators[] = {
	{
		I2C_BOARD_INFO("tps6591x", 0x2D),
		/* FUJITSU TEN:2013-03-07 Change to INT_EXTERNAL_PMU interrupt start */
		.irq		= INT_EXTERNAL_PMU, //TPS6591X_IRQ,
		/* FUJITSU TEN:2013-03-07 Change to INT_EXTERNAL_PMU interrupt end */
...
static struct resource e1853_pda_resources[] = {
	[0] = {
		.name   = "ac",
	},
};

static struct pda_power_pdata e1853_pda_data = {
	.is_ac_online   = ac_online,
};

static struct platform_device e1853_pda_power_device = {
	.name           = "pda-power",
	.id             = -1,
	.resource       = e1853_pda_resources,
	.num_resources  = ARRAY_SIZE(e1853_pda_resources),
	.dev    = {
		.platform_data  = &e1853_pda_data,
	},
};
...
int __init e1853_regulator_init(void)
{
	...
	platform_device_register(&e1853_pda_power_device);
...
FIXED_REG(0, en_3v3, en_3v3, NULL, 1, 1, /* TPS6591X_GPIO_2 */ -1 , true, 1, 3300);
...
#if 0		/* 2013-03-04 FTEN: Don't reprogram PMU GPIO BEGIN */
...
#endif		/* 2013-03-04 FTEN: Don't reprogram PMU GPIO END */
}
