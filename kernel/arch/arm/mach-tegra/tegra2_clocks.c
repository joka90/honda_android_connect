...
static struct clk_pll_freq_table tegra_pll_d_freq_table[] = {
	{ 12000000, 68000000, 272, 6, 8, 4},
	{ 12000000, 81000000, 324, 6, 8, 5},
...
struct clk tegra_list_periph_clks[] = {
	PERIPH_CLK("apbdma",	"tegra-dma",		NULL,	34,	0,	0x31E,	120000000, mux_pclk,			0),
	...
	PERIPH_CLK("sbc1",	"spi_tegra.0",		"spi",	41,	0x134,	0x31E,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("sbc2",	"spi_tegra.1",		"spi",	44,	0x118,	0x31E,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("sbc3",	"spi_tegra.2",		"spi",	46,	0x11c,	0x31E,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("sbc4",	"spi_tegra.3",		"spi",	68,	0x1b4,	0x31E,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	...
	PERIPH_CLK("uarta",	"tegra_uart.0",		NULL,	6,	0x178,	0x31E,	666000000, mux_pllp_pllc_pllm_clkm,	MUX | PERIPH_ON_APB),
	PERIPH_CLK("uartb",	"tegra_uart.1",		NULL,	7,	0x17c,	0x31E,	666000000, mux_pllp_pllc_pllm_clkm,	MUX | PERIPH_ON_APB),
	PERIPH_CLK("uartc",	"tegra_uart.2",		NULL,	55,	0x1a0,	0x31E,	666000000, mux_pllp_pllc_pllm_clkm,	MUX | PERIPH_ON_APB),
	PERIPH_CLK("uartd",	"tegra_uart.3",		NULL,	65,	0x1c0,	0x31E,	666000000, mux_pllp_pllc_pllm_clkm,	MUX | PERIPH_ON_APB),
	...
	PERIPH_CLK("host1x",	"host1x",		NULL,	28,	0x180,	0x31E,	280000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
...
struct clk tegra_list_shared_clks[] = {
	...
	SHARED_CLK("wake.sclk",	"wake_sclk",		"sclk",	&tegra_clk_virtual_sclk),
...
struct clk_duplicate tegra_clk_duplicates[] = {
	...
	CLK_DUPLICATE("sbc1", "spi_slave_tegra_async.0", NULL),
	CLK_DUPLICATE("sbc2", "spi_slave_tegra_async.1", NULL),
	CLK_DUPLICATE("sbc3", "spi_slave_tegra_async.2", NULL),
	CLK_DUPLICATE("sbc4", "spi_slave_tegra_async.3", NULL),
};
