...
static __initdata struct tegra_drive_pingroup_config p852_drive_pinmux[] = {
	...
	SET_DRIVE(SDIO1, DISABLE, ENABLE, DIV_1, 4, 4, SLOWEST, SLOWEST),
	SET_DRIVE(LCD2, DISABLE, DISABLE, DIV_8, 16, 0, FASTEST, FASTEST),
	SET_DRIVE(SPI, DISABLE, DISABLE, DIV_4, 18, 31, SLOWEST, SLOWEST),
#else
	DEFAULT_DRIVE(SDIO1),
	SET_DRIVE(SPI, DISABLE, DISABLE, DIV_1, 18, 22, SLOWEST, SLOWEST),
#endif
	SET_DRIVE(DAP1, DISABLE, ENABLE, DIV_1, 3, 3, SLOWEST, SLOWEST),
	SET_DRIVE(DAP2, DISABLE, ENABLE, DIV_1, 3, 3, SLOWEST, SLOWEST),
	DEFAULT_DRIVE(CDEV1),
	DEFAULT_DRIVE(CDEV2),
	...
	SET_DRIVE(UART3, DISABLE, DISABLE, DIV_4, 18, 31, SLOWEST, SLOWEST),
};
...
static __initdata struct tegra_pingroup_config p852_common_pinmux[] = {
	...
	{TEGRA_PINGROUP_DTE,   TEGRA_MUX_SPI1,          TEGRA_PUPD_NORMAL,
							TEGRA_TRI_NORMAL},
	...
	{TEGRA_PINGROUP_OWC,   TEGRA_MUX_RSVD,          TEGRA_PUPD_PULL_UP,   TEGRA_TRI_TRISTATE},
...
static __initdata struct tegra_pingroup_config p852_nand_pinmux[] = {
	...
	{TEGRA_PINGROUP_ATA,   TEGRA_MUX_GMI,           TEGRA_PUPD_NORMAL,
							TEGRA_TRI_NORMAL},
...
#ifdef CONFIG_BASEBOARD_VAR_1
	SET_DRIVE(SDMMC3, DISABLE, DISABLE, DIV_1, 5, 2, SLOWEST, SLOWEST),
#else
...
void __init p852_pinmux_init(void)
{
	...
	if (system_rev == P852_SKU23 ||
		...
		tegra_drive_pinmux_config_table(p852_drive_pinmux_sku5,
				ARRAY_SIZE(p852_drive_pinmux_sku5));
