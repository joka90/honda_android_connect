...
struct tegra_suspend_platform_data {
	...
	bool early_emc_restore; /* EMC setting restore during resume */
};
...
void tegra_lp0_suspend_emc(void);
void tegra_lp0_resume_emc(void);
...
static inline void tegra_lp0_suspend_emc(void) {}
static inline void tegra_lp0_resume_emc(void) {}
