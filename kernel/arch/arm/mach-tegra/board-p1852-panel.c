...
/* FUJITSU TEN:2012-10-17 Ticket:4984,"I2C Error at resume" start */
static int __init p1852_ada_panel_init(void)
{
	int err;
	struct resource *res;
...
/* FUJITSU TEN:2012-10-17 Ticket:4984,"I2C Error at resume" end */


int __init p1852_panel_init(void)
{
/* FUJITSU TEN:2012-10-17 Ticket:4984,"I2C Error at resume" start */
/* ADA does't use "sku" configuration */
#if 0
	int skuid;
	...
	default:
		printk(KERN_WARNING "%s: unknown skuid %d\n", __func__, skuid);
		return 1;
	}
#else
	return p1852_ada_panel_init();
#endif
/* FUJITSU TEN:2012-10-17 Ticket:4984,"I2C Error at resume" end */
}
