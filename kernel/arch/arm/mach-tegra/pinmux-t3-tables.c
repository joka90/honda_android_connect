...
/* FUJITSU TEN:2013-04-23 Add HDMI release reset start */
    gpio_set_value( TEGRA_GPIO_PV6, 1 );
/* FUJITSU TEN:2013-04-23 Add HDMI release reset end */
...
/* FUJITSU TEN:2012-12-25 control TG-WAKEUP2 end */
	...
	/* set late tristate as normal */
	pm_set_late_tristate_pin(TEGRA_TRI_NORMAL);
#endif /* CONFIG_ADA_BUDET_DETECT */
/* FUJITSU TEN:2012-11-07 Suspend Resume end */
